package com.application.ksgu.Library;
...
public class CustomSearchDialogCompat<T extends Searchable> extends BaseSearchDialogCompat<T> {
	...
	public CustomSearchDialogCompat(
	...
	public CustomSearchDialogCompat setSearchHint(String searchHint) {
		mSearchHint = searchHint;
		if (mSearchBox != null) {
	...
	public CustomSearchDialogCompat setSearchResultListener(
		SearchResultListener<T> searchResultListener
	) {
		mSearchResultListener = searchResultListener;
		return this;
	...
	protected int getLayoutResId() {
		return R.layout.custom_dialog_compat;
	}
	...
	public CustomSearchDialogCompat setTitle(String title) {
		mTitle = title;
		if (mTxtTitle != null) {
			mHandler.post(new Runnable() {
				@Override
