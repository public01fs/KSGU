...
public class PelautAdapter extends BaseAdapter implements Filterable {
    private Activity activity;
    private LayoutInflater inflater;
    private List<Pelaut> newsItems;
    private List<Pelaut> supp;
    private List<Pelaut> suppall;
    //private Filter filter = new CustomFilter();

    public PelautAdapter(Activity activity) {
        this.activity = activity;
        this.newsItems = new ArrayList<>();
    }

    public void setData(List<Pelaut> list) {
        newsItems.clear();
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            public String convertResultToString(Object resultValue) {
                return ((Pelaut) resultValue).getValue();
            }
    ...
    public Pelaut getItem(int position) {
