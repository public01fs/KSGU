...
public class DitkapelAdapter extends BaseAdapter implements Filterable {
    private Activity activity;
    private LayoutInflater inflater;
    private List<Ditkapel> newsItems;
    private List<Ditkapel> supp;
    private List<Ditkapel> suppall;
    //private Filter filter = new CustomFilter();

    public DitkapelAdapter(Activity activity) {
        this.activity = activity;
        this.newsItems = new ArrayList<>();
    }

    public void setData(List<Ditkapel> list) {
        newsItems.clear();
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            public String convertResultToString(Object resultValue) {
                return ((Ditkapel) resultValue).getValue();
            }
    ...
    public Ditkapel getItem(int position) {
