...
public class NegaraAdapter extends BaseAdapter implements Filterable {
    private Activity activity;
    private LayoutInflater inflater;
    private List<Negara> newsItems;
    private List<Negara> supp;
    private List<Negara> suppall;
    //private Filter filter = new CustomFilter();

    public NegaraAdapter(Activity activity) {
        this.activity = activity;
        this.newsItems = new ArrayList<>();
    }

    public void setData(List<Negara> list) {
        newsItems.clear();
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            public String convertResultToString(Object resultValue) {
                return ((Negara) resultValue).getValue();
            }
    ...
    public Negara getItem(int position) {
